...
const projects = [
  ...
  },
  {
    ...
    description: "Responsive website for E-Summit 2025, featuring event details, registration, and community engagement.",
    image: "/esummit.png",
    ...
    filter === "all"
      ...
      : filter === "featured"
        ...
        : filter === "design"
          ...
          : filter === "development"
            ? projects.filter((p) => p.type === "development" || p.type === "design-dev")
    ...
    <section id="projects" className="py-20 relative bg-black/50">
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <p className="max-w-5xl text-muted-foreground">A selection of my design and development work.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          {filteredProjects.map((project, index) => (
            <Card key={index} className="bg-black/50 border border-purple-500/20 overflow-hidden group">
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-4">
                  <div className="flex gap-2">
                    {project.type === "development" || project.type === "design-dev" ? (
                      <>
                        <Button
                          size="sm"
                          variant="outline"
              ...
              <CardContent className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tags.map((tag, i) => (
                    <Badge key={i} className="bg-purple-500/10 text-purple-300 hover:bg-purple-500/20">
                      {tag}
                    </Badge>
                  ))}
                </div>
